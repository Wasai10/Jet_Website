...
export default function Events() {
    ...
    return (
        <section id="events" className="relative w-full py-20 md:py-28 bg-[#00111F] text-white overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <button className="flex items-center space-x-2 text-sm font-semibold text-[#87CEEB] hover:text-white transition-colors duration-300 group self-start md:self-auto">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="lg:col-span-5 relative bg-white/5 backdrop-blur-sm border border-white/5 rounded-2xl overflow-hidden p-7 flex flex-col justify-between transition-all duration-300 hover:bg-white/10 hover:border-white/10 hover:shadow-[0_12px_40px_rgba(0,150,255,0.08)] group cursor-pointer"
                    ...
                    >
                        ...
                        <div className="mb-5">
                            <div className="flex items-end space-x-2">
                                <span className="text-6xl font-black text-white leading-none">{featured.date.day}</span>
                                <div className="flex flex-col mb-1">
                                    <span className="text-[#87CEEB] text-sm font-bold leading-tight">{featured.date.month}</span>
                                    <span className="text-white/30 text-xs leading-tight">{featured.date.year}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex-grow">
                            <h3 className="text-xl font-bold text-white leading-snug mb-3 group-hover:text-[#87CEEB] transition-colors duration-300">
                                {featured.title}
                            </h3>
                        ...
                        {/* CTA */}
                        <button className="mt-7 flex items-center space-x-2.5 text-xs uppercase tracking-widest font-semibold text-[#87CEEB] hover:text-white group/btn transition-colors duration-300">
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-5">
                        {rest.map((event) => (
                            <motion.div
                                ...
                                key={event.id}
                                className="relative flex items-start space-x-5 bg-white/5 backdrop-blur-sm border border-white/5 rounded-xl p-5 transition-all duration-300 hover:bg-white/10 hover:border-white/10 hover:scale-[1.01] hover:shadow-[0_8px_24px_rgba(0,150,255,0.06)] group cursor-pointer"
                            ...
                            >
                                ...
                                <div className="flex-shrink-0 text-center w-12 pl-3">
                                    <div className="text-2xl font-black text-white leading-none">{event.date.day}</div>
                                ...
                                <div className="flex-grow min-w-0">
                                    <div className="flex items-center justify-between gap-2 mb-1.5">
                                        ...
                                        <div className="flex items-center space-x-1 text-white/30 text-[10px]">
                                            <Clock className="w-3 h-3" />
                                            <span>{event.time}</span>
                                        </div>
                                    </div>

                                    <h4 className="text-[15px] font-bold text-white leading-snug mb-1.5 group-hover:text-[#87CEEB] transition-colors duration-300 truncate">
                                        {event.title}
                                    </h4>
                                    <p className="text-[12px] text-white/50 leading-relaxed font-light line-clamp-2">
                                        {event.description}
                                    </p>

                                    <div className="flex items-center space-x-1.5 mt-2.5 text-white/40 text-[11px]">
