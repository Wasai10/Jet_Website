    ...
    return (
        <div className="bg-[#00111F] text-white min-h-screen pt-24 pb-20">
            ...
            <section className="max-w-7xl mx-auto px-6 py-12 text-center">
                <h1 className="text-4xl md:text-6xl font-black mb-4">Ministry Events</h1>
            ...
            <section className="bg-white/5 py-16">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {/* Impact Conference */}
                        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-[#001726] border border-white/10 rounded-3xl p-8 relative overflow-hidden group">
                            ...
                            <h3 className="text-3xl font-bold mb-3">Impact Conference</h3>
                            ...
                            <button className="flex items-center space-x-2 bg-white/10 hover:bg-[#0096FF] px-6 py-3 rounded-full text-sm font-semibold transition-colors">
                        ...
                        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-[#001726] border border-white/10 rounded-3xl p-8 relative overflow-hidden group">
                            ...
                            <div className="flex items-center space-x-2 text-purple-400 mb-4 text-sm font-bold uppercase tracking-widest">
                                <Calendar className="w-4 h-4" />
                                <span>December 2026</span>
                            </div>
                            <h3 className="text-3xl font-bold mb-3">Abacy's Feed the Widow</h3>
                            <div className="flex items-center space-x-2 text-white/60 mb-6">
                                <MapPin className="w-4 h-4" />
                            ...
                            <button className="flex items-center space-x-2 bg-white/10 hover:bg-purple-600 px-6 py-3 rounded-full text-sm font-semibold transition-colors">
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex items-center space-x-3 mb-12">
                        ...
                        <h2 className="text-3xl font-bold">Past Events (2026)</h2>
                    </div>
                    ...
                    <div className="space-y-20">
                        ...
                        <div className="grid lg:grid-cols-2 gap-10 items-center">
                            <div>
                                <span className="text-green-400 font-bold tracking-widest uppercase text-sm mb-2 block">February 2026</span>
                                <h3 className="text-4xl font-bold mb-4">Vision Summit</h3>
                                <p className="text-white/70 mb-4 flex items-center space-x-2"><MapPin className="w-4 h-4"/> <span>Arena of Church Liberties, Kisumu</span></p>
                        ...
                        <div className="grid lg:grid-cols-2 gap-10 items-center">
                            <div className="order-2 lg:order-1">
                                <img src="https://image.pollinations.ai/prompt/group%20of%20kenyan%20nuns%20with%20african%20boys%20in%20a%20childrens%20home?width=800&height=800&nologo=true" alt="Kwetu Home of Peace" className="rounded-3xl w-full h-[400px] object-cover shadow-2xl border border-white/10" />
                            </div>
                            <div className="order-1 lg:order-2">
                                <h3 className="text-4xl font-bold mb-4">Kwetu Home of Peace Mission</h3>
                                <p className="text-white/80 leading-relaxed text-lg">
                        ...
                        <div className="grid lg:grid-cols-2 gap-10 items-center">
                            <div>
                                <h3 className="text-4xl font-bold mb-4">Ossen Girls Mission</h3>
                                <p className="text-white/80 leading-relaxed text-lg">
                        ...
                        <div className="grid lg:grid-cols-2 gap-10 items-center">
                            ...
                            <div className="order-1 lg:order-2">
                                <h3 className="text-4xl font-bold mb-4">Fundraising in Nyakach</h3>
                                <p className="text-white/80 leading-relaxed text-lg">
                        ...
                        <div className="bg-[#001726] border border-white/5 rounded-3xl p-8 md:p-12">
                            <h3 className="text-3xl font-bold mb-6 text-center">Impact Conference Memories</h3>
                        ...
                        <div className="grid lg:grid-cols-2 gap-10 items-center bg-white/5 p-8 md:p-12 rounded-3xl">
                            <div>
                                <h3 className="text-4xl font-bold mb-4">Abacy's Feed the Widow Initiative</h3>
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <p className="font-bold text-white">Our Founder</p>
                                        <p className="text-sm text-white/50">Leading the Initiative</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                        ...
                        <div>
                            <div className="text-center mb-12">
                                <h3 className="text-4xl font-bold mb-4">Home Fellowships</h3>
