...
export default function About() {
    return (
        <section id="about" className="relative w-full py-20 md:py-32 bg-slate-50 dark:bg-[#001726] text-foreground overflow-hidden">
            ...
            <div className="absolute top-12 left-12 w-48 h-48 opacity-[0.02] pointer-events-none text-foreground hidden lg:block">
            ...
            <div className="absolute bottom-12 right-12 w-64 h-64 opacity-[0.02] pointer-events-none text-foreground hidden lg:block">
                <svg viewBox="0 0 100 100" fill="currentColor" className="w-full h-full">
                    <path d="M50 5 L60 30 L55 30 L55 95 L45 95 L45 30 L40 30 Z M20 40 L30 55 L27 55 L27 95 L13 95 L13 55 L10 55 Z M80 40 L90 55 L87 55 L87 95 L73 95 L73 55 L70 55 Z" />
                </svg>
            </div>
            ...
            <div className="relative max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    >
                        {/* Main Image Frame */}
                        <div className="relative rounded-2xl overflow-hidden border border-foreground/10 shadow-2xl group">
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 dark:from-[#001726]/80 via-transparent to-transparent z-10 opacity-60 group-hover:opacity-40 transition-opacity duration-500" />
                            <img
                    ...
                    >
                        {/* Eyebrow tag */}
                        <span className="text-[#87CEEB] dark:text-[#87CEEB] text-[#0096FF] text-xs font-semibold uppercase tracking-widest">
                        ...
                        <p className="text-foreground/80 text-[16px] leading-relaxed font-normal">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                            {/* Vision Card */}
                            <div className="bg-foreground/5 backdrop-blur-sm border border-foreground/10 p-6 rounded-xl transition-all duration-300 hover:bg-foreground/10 hover:border-foreground/15 hover:scale-[1.02]">
                ...
                >
                    ...
                    <motion.button
                        ...
                        className="flex items-center space-x-4 bg-foreground/5 backdrop-blur-sm border border-foreground/10 p-4 rounded-xl shadow-lg transition-all duration-300 hover:bg-foreground/10 hover:border-foreground/15 hover:scale-[1.02] hover:shadow-[0_8px_20px_rgba(0,150,255,0.06)] w-full text-left group"
                    >
                        {/* Icon Container */}
                        <div className="w-10 h-10 rounded-full bg-foreground/5 border border-foreground/10 flex items-center justify-center transition-all duration-300 group-hover:scale-105 group-hover:bg-[#0096FF]/10 group-hover:border-[#0096FF]/20 flex-shrink-0">
                        ...
                        <div className="flex-grow min-w-0">
                            <h4 className="text-[15px] font-bold text-foreground group-hover:text-[#87CEEB] transition-colors duration-300 leading-tight truncate">
                                Our Community
                            </h4>
                            <p className="text-[11px] text-foreground/50 group-hover:text-foreground/70 transition-colors duration-300 leading-tight mt-0.5 truncate">
