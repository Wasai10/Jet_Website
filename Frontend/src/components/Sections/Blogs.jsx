        ...
        >
            ...
            <div className="relative max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-16 md:mb-20">
                    <span className="flex items-center justify-center space-x-2 text-[#0096FF] dark:text-[#87CEEB] text-xs font-semibold uppercase tracking-widest mb-3">
                    ...
                    <p className="text-foreground/60 max-w-2xl mx-auto text-sm md:text-base font-light">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {blogPosts.map((post) => (
                        <article
                            key={post.id}
                            className="bg-foreground/5 backdrop-blur-sm border border-foreground/10 rounded-2xl overflow-hidden group hover:border-[#0096FF]/30 hover:bg-foreground/10 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_15px_40px_rgba(0,150,255,0.1)] flex flex-col"
                        >
                            {/* Image Container */}
                            ...
                            <div className="p-6 md:p-8 flex flex-col flex-grow relative z-10 -mt-6">
                                {/* Meta Info */}
                                <div className="flex items-center space-x-4 text-xs text-[#0096FF] dark:text-[#87CEEB] font-medium mb-4">
                                ...
                                {/* Title */}
                                <h3 className="text-xl font-bold text-foreground leading-tight mb-3 group-hover:text-[#0096FF] dark:group-hover:text-[#87CEEB] transition-colors duration-300 line-clamp-2">
                                    {post.title}
                                </h3>

                                {/* Excerpt */}
                                <p className="text-sm text-foreground/60 leading-relaxed font-light mb-6 flex-grow line-clamp-3">
                                    {post.excerpt}
                                </p>
                                ...
                                <div className="mt-auto pt-4 border-t border-foreground/10">
                                    <a
                                        href="#"
                                        className="inline-flex items-center space-x-2 text-sm font-semibold text-foreground hover:text-[#0096FF] transition-colors duration-300 group/link"
                                    >
