...
const galleryItems = [
    ...
    },
    {
        id: 2,
        category: 'Community',
        src: 'https://media.istockphoto.com/id/1333641112/photo/bible-study-multi-ethnic-group-multi-ethnic-group-of-friends-meet-for-a-bible-study-group.jpg?b=1&s=612x612&w=0&k=20&c=ZmwA6uaqXPpl_0D2pmMFtd5DfElmNXOsfTUCCrminWI=',
    ...
    },
    {
        id: 4,
        category: 'Outreach',
        src: 'https://images.pexels.com/photos/19392550/pexels-photo-19392550.jpeg',
...
export default function Gallery() {
    ...
    return (
        <section id="gallery" className="relative w-full py-20 md:py-28 bg-slate-50 dark:bg-[#001726] text-foreground overflow-hidden">
                    ...
                    {filtered.map((item, index) => (
                        ...
                        >
                            <img
                                src={item.src}
                                alt={item.alt}
                                className={`w-full transition-transform duration-700 group-hover:scale-105 ${item.src.includes('JET_LOGO') ? 'h-40 sm:h-48 md:h-56 object-contain p-6 bg-foreground/5' : 'h-auto object-cover'}`}
                                loading="lazy"
                            />
                            {/* Overlay */}
