...
const galleryCategories = ['All', 'Worship', 'Events', 'Youth', 'Outreach']

const galleryItems = [
  {
    id: 1,
    src: "https://images.pexels.com/photos/2774576/pexels-photo-2774576.jpeg?auto=compress&cs=tinysrgb&w=600",
    alt: "Worship service",
  ...
  {
    id: 2,
    src: "https://images.pexels.com/photos/2717148/pexels-photo-2717148.jpeg?auto=compress&cs=tinysrgb&w=600",
    alt: "Youth event",
  ...
  {
    id: 3,
    src: "https://images.pexels.com/photos/2659470/pexels-photo-2659470.jpeg?auto=compress&cs=tinysrgb&w=600",
  ...
  {
    id: 4,
    src: "https://images.pexels.com/photos/2702976/pexels-photo-2702976.jpeg?auto=compress&cs=tinysrgb&w=600",
    alt: "Christmas event",
  ...
  {
    id: 5,
    src: "https://images.pexels.com/photos/2609639/pexels-photo-2609639.jpeg?auto=compress&cs=tinysrgb&w=600",
    alt: "Bible study",
  ...
  {
    id: 6,
    src: "https://images.pexels.com/photos/2702721/pexels-photo-2702721.jpeg?auto=compress&cs=tinysrgb&w=600",
    alt: "Prayer meeting",
...
export default function Gallery() {
    ...
    return (
        <section className="relative w-full py-20 md:py-28 bg-slate-50 dark:bg-[#001726] text-foreground overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
                    ...
                    <div className="flex items-center space-x-2 bg-foreground/5 border border-foreground/10 rounded-full px-4 py-2 self-start md:self-auto">
                        ...
                        <span className="text-xs text-foreground/60 font-medium">{filtered.length} photos</span>
                    </div>
                </div>
                        ...
                        <button
                            ...
                            className={`px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest border transition-all duration-300 ${
                                activeFilter === cat
                                    ...
                                    : 'bg-foreground/5 border-foreground/10 text-foreground/60 hover:bg-foreground/10 hover:text-foreground hover:border-foreground/20'
                            }`}
                        >
                            {cat}
                        </button>
                ...
                {filtered.length === 0 ? (
                    <div className="text-center py-20">
                        <p className="text-foreground/60">No photos found in this category.</p>
                    </div>
                ) : (
                    <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4">
                        {filtered.map((item, index) => (
                            <div
                                key={item.id}
                                className="break-inside-avoid relative rounded-2xl overflow-hidden group cursor-pointer border border-foreground/10 hover:border-foreground/20 transition-all duration-500 shadow-lg hover:shadow-[0_12px_40px_rgba(0,0,0,0.2)]"
                ...
                <div className="flex justify-center mt-12">
                    <button className="flex items-center space-x-3 px-7 py-3 rounded-full bg-foreground/5 border border-foreground/10 text-sm font-semibold text-foreground/70 hover:bg-[#0096FF]/10 hover:border-[#0096FF]/30 hover:text-[#0096FF] dark:hover:text-[#87CEEB] transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,150,255,0.15)]">
                ...
                <div className="mt-20">
                    <div className="relative w-full rounded-2xl overflow-hidden border border-[#0096FF]/30 bg-foreground/5 backdrop-blur-md shadow-[0_8px_32px_rgba(0,150,255,0.1)] group">
                        ...
                        <div className="flex flex-col md:flex-row items-center p-6 md:p-8 gap-6 md:gap-10 relative z-10">
                            ...
                            <div className="relative w-full md:w-1/3 aspect-video rounded-xl overflow-hidden bg-black/40 border border-foreground/10 flex items-center justify-center flex-shrink-0 group-hover:border-[#0096FF]/40 transition-colors duration-500 cursor-pointer">
                                <img
                                    src="https://images.pexels.com/photos/2774576/pexels-photo-2774576.jpeg?auto=compress&cs=tinysrgb&w=600"
                                    alt="Live Stream"
                            ...
                            <div className="flex flex-col flex-grow text-center md:text-left">
                                ...
                                <p className="text-sm md:text-base text-foreground/70 leading-relaxed font-light mb-6 max-w-xl mx-auto md:mx-0">
