...
export default function About() {
    ...
    return (
        <div className="bg-background dark:bg-[#00111F] text-foreground min-h-screen pt-24 pb-20">
            ...
            <section className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="space-y-6">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold text-foreground">The Origin & History</h1>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="order-2 md:order-1 space-y-6">
                            ...
                            <h3 className="text-4xl font-bold text-foreground">Meet Our Founder</h3>
                            <p className="text-foreground/70 leading-relaxed text-lg">
                        ...
                        <div className="order-1 md:order-2">
                            <img
                                ...
                                alt="Founder"
                                className="w-full h-[500px] object-cover rounded-2xl shadow-2xl border border-foreground/10"
                            />
                        </div>
                    </motion.div>
                </div>
            ...
            {/* 4. What We Believe */}
            <section className="bg-slate-50 dark:bg-[#001726] py-20">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="space-y-10">
                        <div>
                            <h3 className="text-2xl font-semibold mb-3 text-foreground">The Bible</h3>
                        ...
                        <div>
                            <h3 className="text-2xl font-semibold mb-3 text-foreground">God</h3>
                            <p className="text-foreground/70 leading-relaxed">
                                We believe in one God, eternally existing in three persons: Father, Son, and Holy Spirit, equal in power and glory.
                            </p>
                        </div>
                        <div>
                            <h3 className="text-2xl font-semibold mb-3 text-foreground">Jesus Christ</h3>
                            <p className="text-foreground/70 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-2xl font-semibold mb-3 text-foreground">Salvation</h3>
                            <p className="text-foreground/70 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-2xl font-semibold mb-3 text-foreground">The Church</h3>
                            <p className="text-foreground/70 leading-relaxed">
            ...
            <section className="bg-slate-50 dark:bg-[#001726] py-20">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-foreground/60">Meet the dedicated individuals guiding our ministries.</p>
                    </div>
            ...
            {/* 7. Ministries & Leaders */}
            <section className="bg-foreground/5 py-20">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">Our Ministries</h2>
                        <p className="text-foreground/60">Find your place to serve, grow, and connect.</p>
                    </div>
            ...
            <section className="max-w-7xl mx-auto px-6 py-24">
                <div className="relative rounded-[3rem] overflow-hidden bg-slate-50 dark:bg-[#001726] border border-[#0096FF]/20 shadow-[0_0_50px_rgba(0,150,255,0.1)]">
                    ...
                    <div className="relative z-10 p-10 md:p-20 grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-6xl font-black mb-6 leading-tight text-foreground">The JET Band</h2>
