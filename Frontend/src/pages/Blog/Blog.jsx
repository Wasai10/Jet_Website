    ...
    return (
        <div className="bg-background dark:bg-[#00111F] text-foreground min-h-screen pt-24 pb-20">
            ...
            <section className="max-w-7xl mx-auto px-6 py-12 text-center">
                ...
                <h1 className="text-4xl md:text-6xl font-black mb-4 text-foreground">JET Blog & Devotionals</h1>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {blogPosts.map((post, index) => (
                        <motion.article
                            ...
                            className="bg-foreground/5 dark:bg-[#001726] border border-foreground/10 rounded-3xl overflow-hidden group hover:border-[#0096FF]/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_15px_40px_rgba(0,150,255,0.1)] flex flex-col"
                        >
                            {/* Image */}
                            ...
                            <div className="p-8 flex flex-col flex-grow relative z-10">
                                ...
                                <h3 className="text-2xl font-bold text-foreground leading-tight mb-4 group-hover:text-[#0096FF] dark:group-hover:text-[#87CEEB] transition-colors duration-300">
                                    {post.title}
                                </h3>
                                ...
                                <div className="mt-auto pt-6 border-t border-foreground/10">
                                    <a href="#" className="inline-flex items-center space-x-2 text-sm font-semibold text-foreground hover:text-[#0096FF] transition-colors duration-300 group/link">
